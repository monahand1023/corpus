...
[corpus]
db_path = {toml_str(str(a.db_path))}

[embedder]
provider = {toml_str(a.provider)}
model = {toml_str(a.model)}
dim = {a.dim}
...
[[sources]]
name = {toml_str(a.source_name)}
type = {toml_str(a.source_type)}
path = {toml_str(str(a.source_path))}
